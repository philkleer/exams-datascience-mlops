...
def select_best_model(X, y, ti):
    scores = {
        ...
        'DecisionTreeRegressor': ti.xcom_pull(task_ids='train_dt', key='DecisionTreeRegressor'),
        'RandomForestRegressor': ti.xcom_pull(task_ids='train_rf', key='RandomForestRegressor')
    }
    ...
    train_and_save_model(best_model[best_model_name], X, y, '/app/model/best_model.pickle')
...
features, target = prepare_data(path_to_data='./sprint3/exam_airflow/clean_data/fulldata.csv')
