...
X_train, X_test, y_train, y_test = train_test_split(data, target, test_size=0.2, random_state=472)
...
print("Accuracy Score Random Forest: ", round(rf_cv.score(X_test_scaled, y_test), 4), '\n')
...
# Initializing Classifier
vclf = VotingClassifier(estimators=[('knn',knn_best), ('SVM', svm_best), ('Random Forest', rf_best)], voting='hard')
